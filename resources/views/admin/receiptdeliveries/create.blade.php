...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.receiptdelivery.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.receiptdeliveries.store") }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group col-md-2" style="display: inline-block" >
                    <label class="required" for="cus_name">{{ trans('cruds.receiptdelivery.fields.cus_name') }}</label>
                    <input class="form-control {{ $errors->has('cus_name') ? 'is-invalid' : '' }}" type="text" name="cus_name" id="cus_name" value="{{ old('cus_name', '') }}" required>
                ...
                <div class="form-group col-md-2" style="display: inline-block" >
                    ...
                    <input class="form-control {{ $errors->has('p_p_no') ? 'is-invalid' : '' }}" type="number" name="p_p_no" id="p_p_no" value="{{ old('p_p_no', '') }}" step="1" required>
                ...
                <div class="form-group col-md-2" style="display: inline-block" >
                    ...
                    <input class="form-control {{ $errors->has('policy_no') ? 'is-invalid' : '' }}" type="number" name="policy_no" id="policy_no" value="{{ old('policy_no', '') }}" step="1" required>
                ...
                <div class="form-group col-md-2" style="display: inline-block" >
                    ...
                    <select class="form-control select2 {{ $errors->has('car_plate') ? 'is-invalid' : '' }}" name="car_plate_id" id="car_plate_id">
                        @foreach($car_plates as $id => $car_plate)
                            <option value="{{ $id }}" {{ old('car_plate_id') == $id ? 'selected' : '' }}>{{ $car_plate }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col-md-2" style="display: inline-block" >
                    ...
                    <input class="form-control date {{ $errors->has('leave_date') ? 'is-invalid' : '' }}" type="text" name="leave_date" id="leave_date" value="{{ old('leave_date') }}" required>
                ...
                <div class="form-group col-md-2" style="display: inline-block" >
                    ...
                    <input class="form-control {{ $errors->has('contact') ? 'is-invalid' : '' }}" type="number" name="contact" id="contact" value="{{ old('contact', '') }}" step="1" required>
                ...
                <div class="form-group col-md-2" style="display: inline-block" >
                    ...
                    <input class="form-control {{ $errors->has('sec_contact') ? 'is-invalid' : '' }}" type="number" name="sec_contact" id="sec_contact" value="{{ old('sec_contact', '') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('recipient_address') ? 'is-invalid' : '' }}" name="recipient_address" id="recipient_address" required>{{ old('recipient_address') }}</textarea>
