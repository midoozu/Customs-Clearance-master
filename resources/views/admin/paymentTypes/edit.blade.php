        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.payment-types.update", [$paymentType->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('payment_type') ? 'is-invalid' : '' }}" type="text" name="payment_type" id="payment_type" value="{{ old('payment_type', $paymentType->payment_type) }}" required>
