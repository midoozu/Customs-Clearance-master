...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('cruds.receiptVoucher.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.receipt-vouchers.update", [$receiptVoucher->id]) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf

{{--                <div class="form-group col-md-2  style="display: inline-block;" col-2" style="display: inline-block ">--}}
...
{{--                </div>--}}
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control {{ $errors->has('cus_acc_number') ? 'is-invalid' : '' }}" type="number" name="cus_acc_number" id="cus_acc_number" value="{{ old('cus_acc_number', $receiptVoucher->cus_acc_number) }}" step="1" required>
                ...
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control {{ $errors->has('cus_name') ? 'is-invalid' : '' }}" type="text" name="cus_name" id="cus_name" value="{{ old('cus_name', $receiptVoucher->cus_name) }}">
                ...
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control date {{ $errors->has('trx_date') ? 'is-invalid' : '' }}" type="text" name="trx_date" id="trx_date" value="{{ old('trx_date', $receiptVoucher->trx_date) }}" required>
                ...
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control {{ $errors->has('cons_name') ? 'is-invalid' : '' }}" type="text" name="cons_name" id="cons_name" value="{{ old('cons_name', $receiptVoucher->cons_name) }}" required>
                ...
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control {{ $errors->has('bl_no') ? 'is-invalid' : '' }}" type="number" name="bl_no" id="bl_no" value="{{ old('bl_no', $receiptVoucher->bl_no) }}" step="1" required>
                    @if($errors->has('bl_no'))
                ...
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control date {{ $errors->has('eta_date') ? 'is-invalid' : '' }}" type="text" name="eta_date" id="eta_date" value="{{ old('eta_date', $receiptVoucher->eta_date) }}" required>
                ...
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control {{ $errors->has('ship_name') ? 'is-invalid' : '' }}" type="text" name="ship_name" id="ship_name" value="{{ old('ship_name', $receiptVoucher->ship_name) }}" required>
                ...
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control date {{ $errors->has('arrival_date') ? 'is-invalid' : '' }}" type="text" name="arrival_date" id="arrival_date" value="{{ old('arrival_date', $receiptVoucher->arrival_date) }}" required>
                ...
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control {{ $errors->has('discharge_company') ? 'is-invalid' : '' }}" type="text" name="discharge_company" id="discharge_company" value="{{ old('discharge_company', $receiptVoucher->discharge_company) }}" required>
                ...
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control {{ $errors->has('authorization_number') ? 'is-invalid' : '' }}" type="number" name="authorization_number" id="authorization_number" value="{{ old('authorization_number', $receiptVoucher->authorization_number) }}" step="1" required>
                ...
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control date {{ $errors->has('authorization_date') ? 'is-invalid' : '' }}" type="text" name="authorization_date" id="authorization_date" value="{{ old('authorization_date', $receiptVoucher->authorization_date) }}" required>
                ...
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control {{ $errors->has('statement_number') ? 'is-invalid' : '' }}" type="number" name="statement_number" id="statement_number" value="{{ old('statement_number', $receiptVoucher->statement_number) }}" step="1" required>
                ...
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control date {{ $errors->has('statement_date') ? 'is-invalid' : '' }}" type="text" name="statement_date" id="statement_date" value="{{ old('statement_date', $receiptVoucher->statement_date) }}" required>
                ...
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control date {{ $errors->has('delivery_date') ? 'is-invalid' : '' }}" type="text" name="delivery_date" id="delivery_date" value="{{ old('delivery_date', $receiptVoucher->delivery_date) }}" required>
                ...
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control {{ $errors->has('container_partial_wight') ? 'is-invalid' : '' }}" type="number" name="container_partial_wight" id="container_partial_wight" value="{{ old('container_partial_wight', $receiptVoucher->container_partial_wight) }}" step="0.01">
                ...
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control {{ $errors->has('shipment_fee') ? 'is-invalid' : '' }}" type="number" name="shipment_fee" id="shipment_fee" value="{{ old('shipment_fee', $receiptVoucher->shipment_fee) }}" step="0.01" required>
                ...
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control {{ $errors->has('extra_fee') ? 'is-invalid' : '' }}" type="number" name="extra_fee" id="extra_fee" value="{{ old('extra_fee', $receiptVoucher->extra_fee) }}" step="0.01">
                ...
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control {{ $errors->has('total_amount') ? 'is-invalid' : '' }}" type="number" name="total_amount" id="total_amount" value="{{ old('total_amount', $receiptVoucher->total_amount) }}" step="0.01">
