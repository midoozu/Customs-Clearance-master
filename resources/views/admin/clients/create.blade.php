        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.clients.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-2" style="display: inline-block">
                    ...
                    <input class="form-control {{ $errors->has('acc_number') ? 'is-invalid' : '' }}" type="number" name="acc_number" id="acc_number" value="{{ old('acc_number', '') }}" step="1" required>
                ...
                <div class="form-group col-md-2 float-left" style="display: inline-block">
