...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.carPermission.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.car-permissions.store") }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group " style="display: inline-block">
                    ...
                    <input class="form-control date {{ $errors->has('permission_date') ? 'is-invalid' : '' }}" type="text" name="permission_date" id="permission_date" value="{{ old('permission_date') }}" required>
                ...
                <div class="form-group " style="display: inline-block">
                    ...
                    <input class="form-control date {{ $errors->has('exit_date') ? 'is-invalid' : '' }}" type="text" name="exit_date" id="exit_date" value="{{ old('exit_date') }}" required>
                ...
                <div class="form-group " style="display: inline-block">
                    ...
                    <input class="form-control date {{ $errors->has('return_date') ? 'is-invalid' : '' }}" type="text" name="return_date" id="return_date" value="{{ old('return_date') }}" required>
                ...
                <div class="form-group " style="display: inline-block">
                    ...
                    <input class="form-control {{ $errors->has('truck_number') ? 'is-invalid' : '' }}" type="text" name="truck_number" id="truck_number" value="{{ old('truck_number', '') }}" required>
                ...
                <div class="form-group " style="display: inline-block">
                    ...
                    <input class="form-control {{ $errors->has('driver_name') ? 'is-invalid' : '' }}" type="text" name="driver_name" id="driver_name" value="{{ old('driver_name', '') }}" required>
                ...
                <div class="form-group " style="display: inline-block">
                    ...
                    <input class="form-control {{ $errors->has('driver_number') ? 'is-invalid' : '' }}" type="number" name="driver_number" id="driver_number" value="{{ old('driver_number', '') }}" step="1" required>
