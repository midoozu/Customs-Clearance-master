        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('domestic_shipping_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/receipt-vouchers*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                            <i class="fa-fw nav-icon fas fa-cogs">

                            </i>
                            <p>
                                {{ trans('cruds.domesticShipping.title') }}
                                <i class="right fa fa-fw fa-angle-left nav-icon"></i>
                            </p>
                        </a>
                        <ul class="nav nav-treeview">
                ...
                @can('setting_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/invoices-types*") ? "menu-open" : "" }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @endcan
                                @can('driver_data_access')
                                    <li class="nav-item">
                                        <a href="{{ route("admin.driver-datas.index") }}" class="nav-link {{ request()->is("admin/driver-datas") || request()->is("admin/driver-datas/*") ? "active" : "" }}">
                                            <i class="fa-fw nav-icon fas fa-cogs">

                                            </i>
                                            <p>
                                                {{ trans('cruds.driverData.title') }}
                                            </p>
                                        </a>
                                    </li>
                                @endcan
